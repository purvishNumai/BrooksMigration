-- DROP PROCEDURE edw_prod_dbo.generateoccostsdata_20251212();

CREATE OR REPLACE PROCEDURE edw_prod_dbo.generateoccostsdata_20251212()
 LANGUAGE plpgsql
AS $procedure$
Declare
...
details AS (
    ...
    JOIN cost_elements ce ON ce.std_cost_id = csc.std_cost_id
    JOIN (
        SELECT
...
FROM (
    ...
    SELECT
        ...
        effective_end_date,
        effective_start_date
    FROM details WHERE cost_element_code = 'Material'
    UNION ALL
    SELECT
        inventory_item_id::bigint,
        organization_id::bigint,
        ...
        effective_end_date,
        effective_start_date
    FROM details WHERE cost_element_code = 'Material Overhead'
    UNION ALL
    SELECT
        inventory_item_id::bigint,
        organization_id::bigint,
        ...
        effective_end_date,
        effective_start_date
    FROM details WHERE cost_element_code = 'Resource'
    UNION ALL
    SELECT
        inventory_item_id::bigint,
        organization_id::bigint,
        ...
        effective_end_date,
        effective_start_date
    FROM details WHERE cost_element_code = 'Overhead'
    UNION ALL
    SELECT
        inventory_item_id::bigint,
        organization_id::bigint,
        ...
        effective_end_date,
        effective_start_date
    FROM details WHERE cost_element_code = 'Outside Processing'
) d
GROUP BY
    inventory_item_id,
    organization_id,
